import style from "./MatchTwo.module.css";
...
export const MatchTwo = () => {
    ...
    return (
        ...
        // <AiFillDislike className={style.} type="button" onClick={() => handleInteraction("dislike")} />
        // <AiOutlineStar className={style.} />
        // <AiFillLike className={style.} type="button" onClick={() => handleInteraction("like")} />
